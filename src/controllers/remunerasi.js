...
//     tanggalPembelian,
//     keterangan,
//     userId, // harus tetap dikirim di body
//   } = req.body;

//   const gambar = req.file.path.replace(/\\/g, "/");
//   const buktiPembelian = req.body.buktiPembelian; // sementara dari body
//   const proposal = req.body.proposal; // sementara dari body
...
//     tanggalPembelian,
//     gambar,
//     buktiPembelian: buktiPembelian, // sementara dari body
//     proposal: proposal, // sementara dari body
//     keterangan,
//     pemohon: userId, // langsung jadi ObjectId
//   });
...
// exports.updateRemunerasiById = (req, res, next) => {
//   const errors = validationResult(req);
//   if (!errors.isEmpty()) {
//     const err = new Error("Input value tidak sesuai!");
//     err.errorStatus = 400;
...
//   const tanggalPembelian = req.body.tanggalPembelian;
//   const gambar = req.file.path.replace(/\\/g, "/");
//   // const buktiPembelian = req.body.buktiPembelian;
...
//       remun.nama = nama;
//       remun.jumlah = jumlah;
//       remun.periode = periode;
//       remun.tanggalPembelian = tanggalPembelian;
//       remun.gambar = gambar;
//       // remun.buktiPembelian = buktiPembelian;
//       // remun.proposal = proposal;
//       remun.keterangan = keterangan;
//       return remun.save();
//     })
//     .then((result) => {
//       res.status(200).json({
